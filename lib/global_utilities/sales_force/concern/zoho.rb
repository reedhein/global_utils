      ...
      module Zoho
        def attach(zoho_sushi, file_data)
          ...
          begin
            ...
            ::SalesForce::Client.instance.client.create('Attachment',
        ...
        def find_zoho
          @zoho ||= GlobalUtilities::Zoho::Base.counterpart(zoho_id__c) || GlobalUtilities::SalesForce::Determine.new(self)
